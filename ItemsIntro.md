...
Power Cube 是玩家补充 XM 的重要来源，也是战时不可缺少的道具，无论在打塔还是守塔时，大量消耗 XM 都是不可避免的，此时 Power Cube 快速补充 XM 具有重要的意义。建议保留一定数量的 Power Cube 以备急需。  

玩家 Hack Portal 时能较低概率获得自身等级和 Portal 等级两者之中较低者等级的 Power Cube。  
...
<img src="http://ghostflying-static.qiniudn.com/ingress_items_portal_shield_summary.png" width="400" height="200" />

### Link Amp

Link Amp 可以成倍增加 Portal 可连线范围，通常用于建立大范围 Field。对于常见的区域连线，Portal 本身的范围就已经足够，因此较少使用。  

Link Amp 通过 Hack 只能获得 Rare 等级的，Very Rare 级别需要通过 Passcode 获得，虽然其获得概率不高，但由于使用频率更低，对于多数玩家来说应该并不缺少。  
